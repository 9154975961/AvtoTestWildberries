...
public class EchoWorkingBot extends TelegramLongPollingBot {
    ...
    public String getBotToken() {
        return "1528472809:AAHU7cPZFBocuNSwQUzo9vd6QpaEYrZqOW0";
    }
    ...
    public void onUpdateReceived(Update update) {
        try {
            ...
            if (update.hasMessage() && update.getMessage().hasText()) {
                ...
                String str = inMessage.getText();

                if (str.equals("Работаешь?")) {
                    outMessage.setText("не то слово - пашу");
